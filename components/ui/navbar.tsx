    ...
    <nav className="fixed w-full z-50 top-0">
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <Link href="/" className="flex items-center group">
                <span className="text-lg sm:text-xl font-bold bg-gradient-to-r from-electric-purple via-neon-pink to-electric-purple bg-[200%_auto] animate-gradient-x bg-clip-text text-transparent group-hover:from-neon-pink group-hover:via-electric-purple group-hover:to-neon-pink transition-all duration-300">
                  Soul Agents Chat
                </span>
              </Link>
              <Link
              ...
              >
                <div className="relative">
                  <Image
                    ...
                    width={28}
                    height={28}
                    className="relative rounded-full hover:opacity-80 transition-opacity sm:w-8 sm:h-8"
                  />
                </div>
              </Link>
            </div>
            ...
            <button
              ...
              className="lg:hidden p-2 bg-white/5 hover:bg-white/10 rounded-lg transition-all duration-200 group"
              aria-label="Toggle menu"
            >
              <div className="w-5 h-4 flex flex-col justify-between">
                <span
                  className={`w-full h-0.5 bg-gradient-to-r from-electric-purple to-neon-pink transform transition-all duration-300 ${isOpen ? "rotate-45 translate-y-1.5" : ""}`}
                ></span>
                <span
      ...
      {isOpen && (
        <div className="lg:hidden">
          <div className="px-4 py-2 space-y-2 backdrop-blur-xl bg-black/30 border-t border-white/5">
