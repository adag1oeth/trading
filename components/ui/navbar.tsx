        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex-1 flex justify-center">
              ...
              >
                <span className="text-sm text-white/70 group-hover:text-white transition-colors duration-200">Powered by</span>
                <span className="text-sm font-semibold bg-gradient-to-r from-electric-purple via-neon-pink to-electric-purple bg-[length:200%_auto] animate-gradient-x bg-clip-text text-transparent">Brian AI</span>
